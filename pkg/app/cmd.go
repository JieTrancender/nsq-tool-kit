...
// Command is a sub command structure of a cli application. It is recommended
// that a command be created with the app.NewCommand()
type Command struct {
	usage    string
	desc     string
	options  CliOptions
...
// NewCommand creates a new sub command instance based on the given command
// name、desc and other options.
...
// FormatBaseName is used to format executable file name under different
